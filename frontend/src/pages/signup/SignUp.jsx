...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-900 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className="text-center mt-6 text-[17px] text-white">
            ...
            <Link
              to={'/login'}
              className="text-orange-600 font-semibold inline-block hover:text-orange-500"
            >
              Login
            </Link>
          </p>
